...
- **Issuer**: Anthropic
- **Program**: AI Fluency: Framework & Foundations
- **Recipient**: Rehman Ahmad Cheema
- **Completion Date**: July 2026
- **Certificate ID**: *(if available, add here)*
...
- **GitHub**: [@yourusername](https://github.com/RehmanAhmad333)
- **Portfolio**: rehmanahmad.online
